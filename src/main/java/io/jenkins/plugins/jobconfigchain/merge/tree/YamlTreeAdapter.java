...
/**
 * YAML support (see nfr.md's "Minimize new dependency footprint for multi-format content" rule),
 * backed by SnakeYAML's node-graph-preserving {@code compose}/{@code
