...
/**
 * The global Config Set edit page (FR-30/31/32/33), served directly at
...
public class CommonConfigSetPage extends ConfigSetPage {
    ...
    // ---- Template generation (FR-15a/FR-16/FR-40/41/44) ----
    ...
    // meaning here; FR-16's original "ACTIVE version(s) only, never a draft" guarantee is
    // deliberately kept as-is, including the disabled-button gating on {@link #isExists()}.

    /**
     * Jelly-visible: whether the "Generate Template" action should render enabled (FR-40/41 —
     * disabled with a "no active version yet" label when there is nothing to template).
     */
