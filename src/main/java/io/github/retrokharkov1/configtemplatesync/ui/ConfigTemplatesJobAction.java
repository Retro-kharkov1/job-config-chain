 ...
 * concept exists here at all (see {@link io.github.retrokharkov1.configtemplatesync.model.JobConfigTemplateVersion}'s
...
public class ConfigTemplatesJobAction implements Action {
     ...
     * ACTIVE version's declared chain, or an empty array for a brand-new job (no FR-56 default row:
     * a job has no paired project of its own to default to).
     */
    ...
    /**
     * FR-61-equivalent cross-chain type-consistency check, mirroring
     ...
     * EnvConfigSetPage's FR-104 parameter.
     */
    private ChainResolution resolveChain(String baseChainJson, String standaloneContentType) {
        ...
        // No FR-52 default substitution here — an empty job chain stays empty and resolves to {}.
