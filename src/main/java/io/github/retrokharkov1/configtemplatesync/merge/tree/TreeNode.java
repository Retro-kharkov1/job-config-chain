 ...
 * enforcement ({@code ConfigSet.enforceSecretPlaceholders}) — one operation set, three formats
 * (FR-59-FR-70). Every method is a structural primitive; format-specific parsing/serialization
