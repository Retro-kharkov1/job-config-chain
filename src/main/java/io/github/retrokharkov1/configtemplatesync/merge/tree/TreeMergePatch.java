 ...
 * {@link TreeNode} rather than Gson's {@code JsonElement} (FR-66; formerly {@code JsonMergePatch},
 ...
 * array/attribute/repeated-sibling leaf) replaces the target value wholesale (FR-9). Per OQ-8, such
 * whole-value leaves are never merged element-by-element — a documented, known limitation this
