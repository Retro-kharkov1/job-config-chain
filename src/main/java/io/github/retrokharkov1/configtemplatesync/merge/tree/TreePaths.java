 ...
 * used by validate/substitute (FR-17/FR-21), and template generation (FR-15) — format-neutral,
 * operating over {@link TreeNode} rather than any one format's concrete parse tree (FR-66,
 * generalized from the former JSON-only {@code JsonPaths}).
 */
public final class TreePaths {
     ...
     * element-by-element (OQ-8: this plugin replaces such values wholesale, it does not attempt
     * per-element paths/merges).
     */
